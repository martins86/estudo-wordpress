...
echo '<option value="'.$k.'" '.$sel.'>'.$v.'</option>';
 ...
 ?>
  ...
  <div class="crm_field_cell2">
  <input type="url" id="org_url" name="crm[org_url]" class="crm_text" placeholder="<?php esc_html_e('https://my-instance.salesforce.com','woocommerce-salesforce-crm'); ?>" value="<?php echo esc_html($this->post('org_url',$info)); ?>">
  <span class="howto"><?php esc_html_e('Copy your salesforce domain name with https from browser(e.g: https://my-instance.salesforce.com)','woocommerce-salesforce-crm'); ?></span>
  </div>
  <div class="clear"></div>
  </div> 
